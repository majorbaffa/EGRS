...
<body>
	...
	<div class="navbar navbar-fixed-top" >
		<div class="navbar-inner" style="background-color:green;">
			<div class="container">
						...
						<div class="module-foot">
							<div class="control-group">
								<div class="controls clearfix">
									<button type="submit" class="btn btn-primary pull-right" name="submit"  style="background:green; color:white">Login</button>
	...
	<div class="footer" style="background-color:green;">
		<div class="container">
			...
			<b class="copyright" style="color:white">&copy; 2024 E-GRIEVARANCE</b style="color: white;"> All rights reserved.
		</div>
	</div>
