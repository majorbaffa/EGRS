...
<ul class="widget widget-menu unstyled">
							<li >
								<a class="collapsed" data-toggle="collapse" href="#togglePages"  style="background-color:green; color: WHITE;">
...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="state.php"><i class="menu-icon icon-paste"></i>Add Faculty</a></li>
