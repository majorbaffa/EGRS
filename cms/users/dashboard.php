                  ...
                  <div class="col-lg-9 main-chart">
                  	...
                  	<div class="col-md-2 col-sm-2 box0">
                        <div>
                  		...
                  		<div class="col-md-2 col-sm-2 box0" style="background-color: brown;">
...
{?>
                      ...
                      <div class="col-md-2 col-sm-2 box0" style="background-color: green;">
                        <div class="box1">
                  <span class="li_news"></span>
                    <?php 
  $status="in Process";                   
...
{?>
  ...
  <?php }?>
                      ...
                      <div class="col-md-2 col-sm-2 box0" style="background-color: #ffbf00;">
                        <div class="box1">
                  <span class="li_news"></span>
                       <?php 
  $status="closed";                   
