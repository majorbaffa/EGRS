...
error:function (){}
  ...
  <body>
	  <div id="login-page" >
	  	<div class="container">
	<h3 align="center" ><a href="../index.html"  style="	color:green;"> FUD E-GRIEVARANCE SYSTEM</a></h3>
	<hr />
		      <form class="form-login" method="post" >
		        <h2 class="form-login-heading" style="background-color:green;">User Registration</h2>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap" >
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <button class="btn btn-theme btn-block"  style="background-color:green; color: white;" type="submit" name="submit" id="submit"><i class="fa fa-user" style="background-color:green;"></i> Register</button>
		            <hr>
