...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff"><a href="../index.html" style="color:GREEN"><B>.</B></a></h3>
	<hr />
		      <form class="form-login" name="login" method="post">
		        <h2 class="form-login-heading" style="background-color:green">sign in now</h2>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            ...
		            <button class="btn btn-theme btn-block" name="submit" type="submit" style="background-color:green"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
		           </form>
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
		                      ...
		                      <div class="modal-footer">
		                          ...
		                          <button class="btn btn-theme" type="submit" name="change" onclick="return valid();" style="background-color:green; color: WHITE;">Submit</button>
		                      </div>
		                  </div>
		              </div>
		          </div>
    ...
    <script>
        $.backstretch("assets/img/gate.jpg", {speed: 500});
    </script>
